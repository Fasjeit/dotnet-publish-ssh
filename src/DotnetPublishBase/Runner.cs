...
namespace DotnetPublishSsh
{
    public sealed class Runner
    {
        ...
        private static void PrintHelp()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Connection specific options:");
            Console.WriteLine("  --host *    <host>    Host address");
            Console.WriteLine("  --port      <port>    Host port");
            Console.WriteLine("  --user *    <user>    User name");
            Console.WriteLine("  --password  <pswd>    Password");
            Console.WriteLine("  --keyfile   <key>     Private OpenSSH key file");
            Console.WriteLine("  --path *    <path>    Publish path on remote server");
            Console.WriteLine();
